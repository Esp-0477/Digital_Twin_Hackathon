...
class Encoder(nn.Module):
    ...
    """
    def __init__(self, input_dim=400, hidden_dims=[256, 128, 64], latent_dim=2):
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim=2, hidden_dims=[64, 128, 256], output_dim=400):
        ...
        # Output layer with Sigmoid since the inputs are normalized in [0, 1]
...
class VAE(nn.Module):
    ...
    """
    def __init__(self, input_dim=400, latent_dim=2, encoder_hidden=[256, 128, 64], decoder_hidden=[64, 128, 256]):
